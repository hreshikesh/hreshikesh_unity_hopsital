...
<nav class="navbar bg-body-tertiary" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <div class="d-flex gap-3">
            <a href="specialization" class="btn btn-outline-success"><i class="bi bi-arrow-return-left"></i></a>
        </div>
    </div>
</nav>

<c:if test="${not empty result}">
    <p class="w-50 mx-auto alert alert-primary  text-center m-3">${result}</p>
</c:if>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body bg-success-subtle">
                            ...
                            <form action="deleteSpecialization" method="post" class="d-inline">
